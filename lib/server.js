...
const antenna_criteria = require('./antenna_criteria');
...
GeneralRouter.get('/antennaCriteria/:agora_id', antenna_criteria.listCriteria);
GeneralRouter.post('/antennaCriteria/:agora_id', antenna_criteria.setCriterion);
