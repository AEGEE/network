...
describe('API requests', () => {
    ...
    test('should fail if core returns unsuccessful response while fetching user', async () => {
    ...
    test('should fail if core returns unsuccessful response while fetching permissions', async () => {
